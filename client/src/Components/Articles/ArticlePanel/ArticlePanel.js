...
class ArticlePanel extends Component {
  ...
  return(
      ...
      // </Panel>
    <Aux>
      <div onClick={this.handleArticleWindowOpen} className="Panel" footer={<Articleheader title={this.props.title} link={this.props.link} />}>
        <a target="_blank"> <img className="ArticleImage" alt='Article' src={this.props.image}/> </a>
